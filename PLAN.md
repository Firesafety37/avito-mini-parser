# Avito Mini Parser Implementation Plan
...
Нужно ли делать репозиторий публичным сразу? По умолчанию — да, потому что результат удобно отправить ссылкой. Если хочешь приватный — скажи до push.
